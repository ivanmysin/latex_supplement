...
%\begin{equation}
%α_m(V)=\frac{0.48(1/\normalsubformula{\text{ms}})}{1+\frac{0.18(\normalsubformula{\text{mM}})}ca}_in}}}\cdot
%e^{(-1.68\cdot V\cdot Q(\text{deg}C))}}
%\end{equation}

%\begin{equation}
%β_m(V)=\frac{0.28(1}{1+\frac{[ca]_in}}}{0.011(\normalsubformula{\text{mM}})\cdot
%e^{(-2\cdot V\cdot Q(\text{deg}C))}}}
%\end{equation}
...
%\begin{equation}
%x=\frac{0.0853\cdot (T+\text{deg}C)} 2,f(z)=?\begin{matrix}\left\{1-\frac z 2\text{     if
%abs}(z)<10^{\text{-4}}?\right.\left\{\frac z{e^z-1}\text{      otherwise}?\right.\mathit{no}\end{matrix}\{?
%\end{equation}
...
%\normalsubformula{\text{drive}}_channel}}=?\begin{matrix}\left\{-f_e\cdot
%\frac{I_{\text{Ca}}}{0.2\cdot \text{FARADAY}}\text{   if
%}\normalsubformula{\text{drive}}_channel}}>0\normalsubformula{\text{mM}}/\normalsubformula{\text{ms}}?\right.\left\{0\text{
%                      }\normalsubformula{\text{otherwise}}?\right.\mathit{no}\end{matrix}\{?

%\begin{equation}
%\frac{dca}{dt}=drive\_channel +\frac{(10^{-4}(\normalsubformula{\text{mM}})-\normalsubformula{\text{ca}})}{7\cdot
%200 ms}
%\end{equation}
...
%\begin{equation}
% \frac{d[Ca^{2+}]_i}{dt}=B{\sum
%}I_Ca}}-\frac{[\normalsubformula{\text{Ca}}^{2+}]_i-[\normalsubform%ula{\text{Ca}}^{2+}]_0}
% τ
%\end{equation}
